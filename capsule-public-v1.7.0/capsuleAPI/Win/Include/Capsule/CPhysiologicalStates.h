...
/**
 * \brief Set handler for physiological states initialized delegate
 */
...
/**
 * \brief Set handler for physiological states calibrated delegate
 */
...
/**
 * \brief Initialize physiological states classifier
 *
 * \param states classifier handle
 */
 ...
 */
CL_DLL void clCPhysiologicalStates_ImportBaselines(clCPhysiologicalStates states, const clCPhysiologicalStatesBaselines* baselines) NOEXCEPT;

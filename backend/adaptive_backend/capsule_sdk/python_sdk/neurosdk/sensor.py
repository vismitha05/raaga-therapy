...
class Sensor:
    ...
    def sens_family(self) -> SensorFamily:
        family = _neuro_lib.getFamilySensor(self.sensor_ptr)
    ...
    def is_supported_feature(self, future: SensorFeature) -> bool:
        ...
        """
        supported = _neuro_lib.isSupportedFeatureSensor(self.sensor_ptr, future.value)
    ...
    def is_supported_command(self, sensor_command: SensorCommand) -> bool:
        ...
        """
        supported = _neuro_lib.isSupportedCommandSensor(self.sensor_ptr, sensor_command.value)
        return bool(int(supported))
    ...
    def is_supported_parameter(self, sensor_parameter: SensorParameter) -> bool:
        ...
        """
        supported = _neuro_lib.isSupportedParameterSensor(self.sensor_ptr, sensor_parameter.value)
        return bool(int(supported))
